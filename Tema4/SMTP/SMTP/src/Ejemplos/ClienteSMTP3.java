...
public class ClienteSMTP3 {
	public static void main(String[] args) throws NoSuchAlgorithmException, UnrecoverableKeyException,
		...
		String username = "alvaro.quispe.psp@gmail.com";
		String password = "besugogvxizsrsgy";
		int puerto = 587;
		String remitente = "alvaro.quispe.psp@gmail.com";
		...
		try {
			...
			if (client.execTLS()) {
				...
				if (client.auth(AuthenticatingSMTPClient.AUTH_METHOD.LOGIN, username, password)) {
					...
					String destino1 = "alvaro.quispe.psp@gmail.com";
